...
import { TAG_CANDIDATES } from "../ir/types.js";
import { rewriteIR } from "./rewrite.js";
import { applyRecordify } from "./recordify.js";
import { applyHintsOnIR } from "./hint-dedup.js";
import { applyAutoRecursive } from "./auto-recursive.js";
import { applyFieldTagConsolidation } from "./field-tag.js";
import { applyTagHints } from "./tag-hints.js";
import { applyInlineUnify } from "./inline-unify.js";
import { applyInlineSameKeys } from "./inline-samekeys.js";
...
export function runPipeline(root: Schema, opts: PipelineOptions): PipelineResult {
  ...
  const hoistNames = new Map<Schema, string>([
    ...sameKeysRes.hoistNames,
    ...tagHintsRes.hoistNames,
  ]);
