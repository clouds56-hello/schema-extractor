...
import { hasTagKey, pickTagLiteral } from "../ir/tags.js";
import { collectHoists, type HoistMeta } from "../emit/hoist.js";
import { ROOT_CTX, pascal, sha8 } from "../emit/name.js";
import { mergeGroup } from "../policy/combine.js";
import { INLINE_SAMEKEYS_POLICY } from "../policy/presets.js";
