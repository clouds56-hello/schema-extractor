...
import { collectHoists, makeInlineMeta, type HoistMeta } from "../emit/hoist.js";
import { ROOT_CTX } from "../emit/name.js";
import { mergeGroup } from "../policy/combine.js";
import { INLINE_VS_HOISTED_POLICY, INLINE_INLINE_POLICY } from "../policy/presets.js";
